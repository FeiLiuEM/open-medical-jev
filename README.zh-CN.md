...
> **与 Jev、OpenJev 同级的效果——全程零训练。** 600 题制三国执业医师卷：中国卷距 Jev
> 2.0pp（0.8767 vs 0.8967），印度卷 2.3pp（0.7900 vs 0.8133），与 OpenJev 开源权重基本持平
> （印度反超 +1.5pp）；单卡 24GB 本地 ~0.28 秒/题；路由可自动放行中国卷 55.0% 的题、
> 放行部分准确率 98.2%。无微调、无蒸馏、无语料。
...
| **本项目 — 27B** | **0.8767** | 0.7437 | **0.7900** |
| 本项目 — 35B-A3B | 0.8667 | 0.7352 | 0.7533 |
